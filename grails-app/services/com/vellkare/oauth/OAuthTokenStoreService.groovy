...
@Transactional
class OAuthTokenStoreService implements TokenStore {
  ...
  void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
    ...
    def authenticationPropertyName = accessTokenLookup.authenticationPropertyName
    def authenticationJsonPropertyName = accessTokenLookup.authenticationJsonPropertyName
    ...
    def authMap = [
      'oauth2Request': authentication.OAuth2Request.properties,
      'userAuth'     : authentication.userAuthentication ? authentication.userAuthentication.properties : ''
    ]
    ...
    def ctorArgs = [
      ...
      (authenticationJsonPropertyName): (authMap as JSON).toString(),
